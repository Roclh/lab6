...
public class Load extends Command {
    ...
    /**
     * @author Roclh
     * Данный класс позволяет загружать в текущую коллекцию из текущего установленного для чтения файла. Комманда является временной и нужна для удобства пользования программой.
     */
